...
<nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
    ...
    <div class="navbar-wrapper">
			...
			<a class="navbar-brand" href="#pablo">Activation Page</a>
		</div>
...
<!-- End Navbar -->
    ...
    <div class="full-page login-page bg " filter-color="rose" >
      <img src="assets/img/bg14.jpg" alt="">
        ...
        <style>
        html { 
          background: url(assets/img/bg14.jpg) no-repeat center center fixed; 
...
<div class="card card-signup text-center">
    ...
    <div class="card-header ">
     <h4 class="card-title">Activate Account</h4>
                            ...
                            <h5 class="card-description"> Change your password? </h5>
                            </div>
    </div>
    ...
    <?php 
       if (isset($_GET['id'])) {
           $id= $_GET['id'];
            ...
            where user_id='$id'
           ";
           $sql_q= mysqli_query($con,$sql1);
          $row= mysqli_fetch_array($sql_q);

          if (isset($_POST['reset'])) {
            $pasword1=mysqli_real_escape_string($con, $_REQUEST['password1']);
            $pasword2=mysqli_real_escape_string($con, $_REQUEST['password2']);

            $query="UPDATE users SET 
                    $passwor1='user_password'
                    WHERE $id='user_id'
             ";
     ...
     ?>        
            <form class="form" method="post" action=""  enctype="multipart/form-data">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="<?=$row['user_email']?>" disabled>
                                </div>
                                  <div class="input-group">
                                    <div class="input-group-prepend">
                                      <div class="input-group-text">
              ...
              <div class="card-footer ">
                   <input class='btn btn-next btn-fill btn-wd btn-round btn-primary' type="button" name="reset" value="RESET"></input>
              </div>
                            </form>      
    </div>
  ...
  $(document).ready(function(){
    $().ready(function(){
        ...
        $('.fixed-plugin a').click(function(event){
          // Sarah if we click on switch, stop propagation of the event, so the dropdown will not be hide, otherwise we set the  section active
