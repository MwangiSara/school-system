...
<!-- End Navbar -->
    ...
    <div class="full-page login-page bg " filter-color="rose" >
      <img src="assets/img/bg13.jpg" alt="">

        <!--   you can change the color of the filter page using: data-color="blue | purple | green | orange | red | rose " -->
        <style>
        html { 
          background: url(assets/img/bg13.jpg) no-repeat center center fixed; 
     ...
     <div class="content">
            <div class="container">
             <!--  <?php include 'main/includes/flash.php'; ?> -->
                ...
                $sql="SELECT count(*) as count,user_id ,user_access,verification from users where user_email='$user_email' and user_password='$user_password'";
                      ...
                      if ($count > 0) {
                          $sql2="SELECT * FROM users WHERE user_email='{$user_email}' and user_password='{$user_password}'";
                $results=mysqli_query($con,$sql2);
                while ($row=mysqli_fetch_array($results))
                {
                        $u_id=$row['user_id'];
                        $u_access=$row['user_access'];
                        $u_verification=$row['verification'];
                        $u_email=$row['user_email'];
                        $u_password=$row['user_password'];


                if ($user_email ==  $u_email && $user_password == $u_password &&  $u_verification <>'verified' ) {

                    echo "<span style='color: red'>ERROR: LOGIN TO YOUR EMAIL AND VERIFY YOUR ACCOUNT</span>";
                   }
               else if($user_email ==  $u_email && $user_password == $u_password && $u_access== 'dormant') {
                  ...
                  redirect('main/dashboard/index.php');
                    ...
                    echo "<span style='color: red'>ERROR: WRONG PASSWORD</span>";
                        }
                       }
                      }
                  ?>
...
$error= $_SESSION['error'];
  ?>
                ...
                <input type="password" name="user_password" placeholder="Password..." class="form-control">
                  ...
                  <input type="submit" class="btn btn-primary btn-round btn-lg btn-block mb-3" value="login" name="login">
                  <div class="pull-left">
                  <h6><a href="#pablo" class="link footer-link">Create Account</a></h6>
                  </div>

                  <div class="pull-right">
                  <h6><a href="forgot_password.php" class="link footer-link">Forgot Password?</a></h6>
                  </div>
                  </div>
    ...
    <div class=" container-fluid ">
        ...
        <div class="copyright" id="copyright">
            &copy; <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script>, powered by <a href="https://www.nanasystems.co.ke/" target="_blank"></a> <a href="#" target="_blank">NANA SYSTEMS</a>.
        </div>
    </div>
...
<script src="ssets/demo/demo.js"></script>
